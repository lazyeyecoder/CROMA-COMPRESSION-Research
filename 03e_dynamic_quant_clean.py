...
def main():
    ...
    torch.save(croma_q.state_dict(), "CROMA_INT8_Dynamic.pt")
    size_mb = os.path.getsize("CROMA_INT8_Dynamic.pt") / (1024*1024)
    ...
    print(f"Dynamic INT8 mIoU: {miou:.4f}")
    ...
    with open("results_dynamic_quant.txt", "w") as f:
